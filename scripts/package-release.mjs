...
const release = {
  ...
  devpostStatus: submitted
    ...
    : "draft; story, tagline, technology and product links saved; media and final submission pending",
  video: {
    file: video.file,
