...
y=para("An internal mission approval depends on facts that can change. GroundProof links jobs to source snapshots and requires a fresh decision after evidence changes. Expired or unavailable evidence prevents signoff.",M,y-21,W-2*M,11.3,16)
rule(y-20)
y-=43
label("THE WORKFLOW",M,y,9)
y=para("Capture a public source or record an operator-supplied excerpt and reference. A person reviews its exact content. Signoff checks the mission revision and evidence hashes. Changes identify affected jobs and invalidate old approvals. Capture history and export preserve retained evidence.",M,y-16,W-2*M,10.8,15.3)
y-=29
label("WHAT THE PILOT TESTS",M,y,9)
y=para("Can a coordinator reduce total review effort, including maintaining private records and handling alerts? The pilot runs alongside the operator's existing process. Operators retain original permission documents and make all flight decisions.",M,y-16,W-2*M,10.8,15.3)
y-=25
...
y=para("Proposed price: <b>$199 per workspace per month</b>. The current product and initial pilot use one coordinator account. Shared team roles remain future work. Illustrative time value is $267/month at 100 jobs, four minutes saved per job, and $40/hour. At 50 jobs it is $133, below the price. The pilot must establish the actual inputs and value.",M,y-16,W-2*M,10.6,15)
y-=24
label("ENTRY CONTROLS AND STOP CONDITIONS",M,y,9)
y=para("Save the account recovery key and test password rotation. Verify TLS, access controls and backup restore before loading data. Agree source access and retention. Export needed capture history before source deletion. Stop for an approval bypass or data-access defect. Keep the established operational process.",M,y-16,W-2*M,10.6,15)
y-=24
label("THE ASK",M,y,9)
...
y=para("<b>Current evidence:</b> working software with saved-key recovery, capture history, authenticated Anakin retrieval and labeled simulations. No customer traction, flight validation, certification, or measured commercial savings claimed. AI-assisted development and research.",M,y-16,W-2*M,9,12.5,"muted")
y=para('Product: <link href="https://groundproof-flight.web.app" color="#08694F">groundproof-flight.web.app</link><br/>Repository: <link href="https://github.com/shi1720/HTCJ" color="#08694F">github.com/shi1720/HTCJ</link><br/>Source context: <link href="https://www.faa.gov/uas/state-and-local-regulation-unmanned-aircraft-systems" color="#08694F">FAA jurisdiction guidance</link>. Research inspected September 23, 2026. Full source register and pilot definitions are in the repository.',M,y-12,W-2*M,8.3,11,"muted")
